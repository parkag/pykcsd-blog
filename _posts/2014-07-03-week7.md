...
The approach proposed for two dimensions in kCSD 2D seems a bit unclear to me:
...
<figure>
	<a href="{{ site.url }}/images/sources_3D.jpg"><img src="{{ site.url }}/images/sources_3D.jpg"></a>
...
This scales well from 2D to 3D (and beyond), since it's based on the conception of (hyper)volume.
...
* investigate how much speedup can be achieved
	...
	* investigate if Monte Carlo integration would be useful for triple integrals
