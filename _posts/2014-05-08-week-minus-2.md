...
An IPython Notebook may be viewed [here](http://nbviewer.ipython.org/github/parkag/notebooks/blob/master/pykCSD/pykCSD.ipynb)(sometimes you need to refresh the page few times before it renders).
